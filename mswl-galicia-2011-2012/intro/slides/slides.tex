...
%% Metadatos del PDF.
\hypersetup{
  pdftitle={Introduction to Libre Software / Master on Libre Software (Galicia)},
...
\subtitle{Master on Libre Software (Galicia) \\
...
\begin{flushright}
\copyright 2000-2011 Jesus M. Gonzalez-Barahona, Gregorio Robles. \\
