...
\item wrap\_content: Ocupa la anchura o altura mínima necesaria
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{TableLayout}
\begin{itemize}
\item Layout específico para mostrar tablas
\item Se puede realizar también con RelativeLayouts
\item Columas y Filas son sus principales propiedades
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Nunca usar AbsoluteLayout
\item Usar el mínimo número de vistas posibles
\item Nunca más de 80 layouts en una misma vista, y nunca más de 10
  layouts anidados
\item Pantallas y vistas sencillas
\item Utilizar recursos apropiados para cada tipo de pantalla
\end{itemize}
\end{frame}
\end{document}
