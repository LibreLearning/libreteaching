...
\item The output of the master thesis will be:
  ...
  \end{itemize}
\item All this will be evaluated by a commmittee (lecturers and external experts)
\item There may be request for changes (and several rounds)
\item All materials will be published and publizied in the master website
\end{itemize}
...
\begin{frame}
\frametitle{Looking for excelence!}

The master thesis supposes the best opportunity for master students
to show their acquired knowledge and habilities during the master
